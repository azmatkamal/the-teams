...
import { getGames, addorUpdateGame } from "../../redux/game_types/action";
...
class AddCountry extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps && nextProps.game && nextProps.game.en_name) {
      this.setState({
        en_name: nextProps.game.en_name,
        ar_name: nextProps.game.ar_name,
        id: nextProps.game._id,
      });
    }
...
export default withRouter(
  connect(mapDispatchToProps, { getGames, addorUpdateGame })(AddCountry)
);
