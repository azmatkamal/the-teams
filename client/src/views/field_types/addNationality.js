...
import { getFields, addorUpdateField } from "../../redux/field_types/action";
...
class AddField extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps && nextProps.field && nextProps.field.en_name) {
      this.setState({
        en_name: nextProps.field.en_name,
        ar_name: nextProps.field.ar_name,
        id: nextProps.field._id,
      });
    }
...
export default withRouter(
  connect(mapDispatchToProps, { getFields, addorUpdateField })(AddField)
);
