...
import {
  getNationalities,
  addorUpdateNationality,
} from "../../redux/nationality/action";
...
class AddCountry extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps && nextProps.nationality && nextProps.nationality.en_name) {
      this.setState({
        en_name: nextProps.nationality.en_name,
        ar_name: nextProps.nationality.ar_name,
        id: nextProps.nationality._id,
      });
    }
  ...
  onSubmit = () => {
    ...
    this.props.addorUpdateNationality(
      formData,
...
export default withRouter(
  connect(mapDispatchToProps, { getNationalities, addorUpdateNationality })(
    AddCountry
  )
);
